    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <ApiKeyManager 
                ...
                openRouterApiKey={globalProps.openRouterApiKey}
                setOpenRouterApiKey={globalProps.setOpenRouterApiKey}
                openaiApiKey={globalProps.openaiApiKey}
                setOpenaiApiKey={globalProps.setOpenaiApiKey}
                pollinationsApiKey={globalProps.pollinationsApiKey}
                setPollinationsApiKey={globalProps.setPollinationsApiKey}
            />
