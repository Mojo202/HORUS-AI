...
export const MEDICAL_IMAGE_PROMPT_TEMPLATE = `A hyper-realistic, professional medical illustration of {{ARTICLE_TITLE}}, presented in a colored X-ray and anatomical dissection style. The image must be scientifically and academically accurate to a very high degree. The central diagram should be clear and didactic, showcasing the key anatomical structures with precise English labels. All text labels must be in English only. Include comparative diagrams where relevant (e.g., 'healthy' vs. 'injured'). Use distinct, vibrant, and contrasting colors to differentiate anatomical structures. The background must be a clean white. The style should be educational, 4K resolution, ultra high quality.`;
